...
def about():
    showinfo("About this program","This is the problem written by youuu as the problem")
def quit():
    window.destroy()
...
fuck_menu = Menu(menu_bar,tearoff=0)
menu_bar.add_cascade(label="Fuck",menu=fuck_menu)
fuck_menu.add_checkbutton(label="tk")
